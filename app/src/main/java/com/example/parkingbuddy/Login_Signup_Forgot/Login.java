...
public class Login extends FragmentActivity implements
        ...
        ForgotPasswordFragment.ForgotPasswordSuccessListener,
    ...
    private ButtonFlat forgotPasswordButton;
...
//
//        loginButton = (ButtonRectangle) findViewById(R.id.btn_login);
...
//            }
//        });
//        signupButton = (ButtonRectangle) findViewById(R.id.btn_signup);
//        signupButton.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
//                signup(usernameTextView.getText(),passwordTextView.getText());
//            }
//        });
//        forgotPasswordButton = (ButtonFlat) findViewById(R.id.btn_ForgetPass);
...
//        });
    ...
    public void onLoginHelpClicked() {
        ...
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(fragmentContainer, ForgotPasswordFragment.newInstance(configOptions));
        transaction.addToBackStack(null);
        transaction.commit();
    }
